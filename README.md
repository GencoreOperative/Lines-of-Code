...
- **loc-by-blame** — count lines currently attributed to an author via `git blame`
...
This produces three executables in the project root: `loc-authors`, `loc-by-blame`, and `loc-by-user`.
...
```sh
./loc-by-blame -r /path/to/repo -n "Joe Bloggs"
```
